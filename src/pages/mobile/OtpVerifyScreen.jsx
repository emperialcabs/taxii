    ...
    <div className="real-mobile-app">
      ...
      <div className="verify-screen-body" style={{ padding: '24px 20px', display: 'flex', flexDirection: 'column', alignItems: 'center', flex: 1 }}>
        <div style={{ textAlign: 'center', flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '20px', width: '100%' }}>
          ...
          {/* OTP Verification PNG Image */}
          <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', width: '100%', maxWidth: '300px', minHeight: '200px', margin: '0 auto' }}>
            <img 
              src={otpVerifyImg} 
              alt="Verification" 
              className="onboarding-hero-img"
              style={{ maxWidth: '100%', maxHeight: '240px', objectFit: 'contain', filter: 'drop-shadow(0 12px 24px rgba(0,0,0,0.06))' }}
            />
          </div>
