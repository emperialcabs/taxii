    ...
    <div className="real-mobile-app">
      ...
      <div className="verify-screen-body" style={{ padding: '24px 20px', display: 'flex', flexDirection: 'column', alignItems: 'center', flex: 1 }}>
        <div style={{ textAlign: 'center', flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '20px', width: '100%' }}>
          ...
          {/* OTP Verification 3D MNC Vector Graphic */}
          <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', width: '100%', maxWidth: '280px', height: '200px', margin: '0 auto' }}>
            <svg viewBox="0 0 320 230" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', height: '100%' }}>
              ...
              {/* Desktop / Laptop Verification Screen Window */}
              <g filter="url(#otpMonitorShadow)" transform="translate(30, 20)">
                ...
                <text x="105" y="66" textAnchor="middle" fontFamily="Space Grotesk, sans-serif" fontSize="6.5" fontWeight="600" fill="#64748B">Please enter the OTP code sent to your number</text>

                {/* Simulated 4 Input Boxes inside Browser Window */}
                <g transform="translate(68, 74)">
                  <rect x="0" y="0" width="16" height="20" rx="4" fill="#F8FAFC" stroke="#E2E8F0" strokeWidth="1" />
                  <text x="8" y="14" textAnchor="middle" fontFamily="League Spartan, sans-serif" fontSize="11" fontWeight="800" fill="#0F172A">3</text>

                  <rect x="20" y="0" width="16" height="20" rx="4" fill="#F8FAFC" stroke="#E2E8F0" strokeWidth="1" />
                  <text x="28" y="14" textAnchor="middle" fontFamily="League Spartan, sans-serif" fontSize="11" fontWeight="800" fill="#0F172A">3</text>

                  <rect x="40" y="0" width="16" height="20" rx="4" fill="#F8FAFC" stroke="#E2E8F0" strokeWidth="1" />
                  <text x="48" y="14" textAnchor="middle" fontFamily="League Spartan, sans-serif" fontSize="11" fontWeight="800" fill="#0F172A">8</text>

                  <rect x="60" y="0" width="16" height="20" rx="4" fill="#FFFBEB" stroke="#FFB800" strokeWidth="1" />
                </g>

                {/* Submit Button */}
                <rect x="88" y="104" width="34" height="12" rx="4" fill="#FFB800" />
                <text x="105" y="112" textAnchor="middle" fontFamily="League Spartan, sans-serif" fontSize="7" fontWeight="900" fill="#FFFFFF">SUBMIT</text>
              </g>

              {/* Floating Golden Security Shield Badge with Checkmark */}
              <g filter="url(#shieldGlow)" transform="translate(230, 15)" className="ob-animate-float">
                ...
                {/* Dark Blue Circle inside Shield */}
              ...
              {/* Character Sitting at Chair with Phone/Laptop on Left */}
