            ...
            {drivers.map((drv, idx) => (
              <div key={idx} className="card driver-card">
                ...
                <div className="driver-info">
                  ...
                  <h3>{drv.name}</h3>
                  <p className="driver-since">Cabsy Driver Since {drv.since}</p>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="recruitment-card section-mint">
            <div className="grid-2-cols align-center">
              <div className="recruitment-text">
                <h2>Wanna Become A Part of Our Dedicated Team of Cabsy Drivers?</h2>
          ...
          <div className="grid-2-cols">
            <div className="card story-quote-card">
              ...
              <p className="quote-body">
                "Being Cabsy taxi driver has not only provided me with a stable income but has also opened doors to endless opportunities and personal growth."
              </p>
              <div className="quote-author-info">
                <strong>— Craig Carter</strong>
                <small>Cabsy Driver Since 2019</small>
              </div>
            </div>
            ...
            <div className="card story-quote-card">
              ...
              <p className="quote-body">
                "What I love most about being a driver with Cabsy is the freedom and flexibility it offers, allowing me to strike a perfect work-life balance."
              </p>
              <div className="quote-author-info">
                <strong>— Marwane Perez</strong>
                <small>Cabsy Driver Since 2021</small>
              </div>
            </div>
          </div>
        </div>
